CREATE EXTERNAL TABLE `project_customer_landing_landing_table`(
...
LOCATION
  's3://udacity-project-datalake/customer/landing_table/'
TBLPROPERTIES (
  'CrawlerSchemaDeserializerVersion'='1.0', 
  'CrawlerSchemaSerializerVersion'='1.0', 
  'UPDATED_BY_CRAWLER'='project_customer_landing_crawler', 
